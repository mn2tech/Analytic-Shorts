...
const API_REPORTS = [
  ...
  { id: 'samgov-live', name: 'SAM.gov Opportunities (Live)', description: 'Real-time federal contract opportunities from SAM.gov (posted within the last 30 days by default)', endpoint: '/api/example/samgov/live?ptype=o&limit=1000' },
