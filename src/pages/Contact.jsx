  ...
  return (
    <div className="max-w-2xl mx-auto px-4 sm:px-6 py-12">
      ...
      <div className="rounded-xl border border-gray-200 bg-white shadow-sm p-6 space-y-4">
        ...
        <a
          href="mailto:support@nm2tech-sas.com?subject=Federal%20Entry%20Brief%20Inquiry"
          className="inline-flex items-center justify-center px-6 py-2.5 rounded-lg font-medium text-white bg-indigo-600 hover:bg-indigo-700"
        >
          Send Email
        </a>
      </div>
