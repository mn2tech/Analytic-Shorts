    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 watermark-bg relative">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-16">
          <h2 className="text-2xl font-bold text-gray-900 text-center mb-2">Community Feed</h2>
          <p className="text-gray-600 text-center mb-6">
            Discover dashboards shared by the community. Explore insights, get inspired, and share your own.
          </p>
          <div className="text-center">
            <Link
              to="/feed"
