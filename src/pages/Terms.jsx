          ...
          <div className="prose prose-sm max-w-none">
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                By accessing or using NM2TECH Analytics Shorts ("Service"), you agree to be bound by these Terms of Service ("Terms"). If you disagree with any part of these terms, you may not access the Service.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                NM2TECH Analytics Shorts is a cloud-based analytics platform that allows users to upload data files, generate visualizations, and obtain AI-powered insights. We reserve the right to modify, suspend, or discontinue any part of the Service at any time.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc pl-6 text-gray-700 mb-4 space-y-2">
                <li>Upload any data that violates any law or regulation</li>
                <li>Upload data containing viruses, malware, or harmful code</li>
            ...
            <section className="mb-8">
              <h2 className="text-xl font-semibold text-gray-900 mb-4">6. Data Ownership and Privacy</h2>
              <ul className="list-disc pl-6 text-gray-700 mb-4 space-y-2">
                ...
                <li>You are responsible for ensuring you have the right to upload and process the data</li>
                <li>You can delete your data at any time through the Service</li>
              </ul>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                The Service and its original content, features, and functionality are owned by NM2TECH and are protected by international copyright, trademark, patent, trade secret, and other intellectual property laws.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                We strive to provide reliable service but do not guarantee that the Service will be available 100% of the time. We may experience downtime due to maintenance, updates, or unforeseen circumstances.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                TO THE MAXIMUM EXTENT PERMITTED BY LAW, NM2TECH SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, OR ANY LOSS OF PROFITS OR REVENUES, WHETHER INCURRED DIRECTLY OR INDIRECTLY, OR ANY LOSS OF DATA, USE, GOODWILL, OR OTHER INTANGIBLE LOSSES.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                You agree to indemnify and hold harmless NM2TECH and its officers, directors, employees, and agents from any claims, damages, losses, liabilities, and expenses arising out of your use of the Service or violation of these Terms.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc pl-6 text-gray-700 mb-4 space-y-2">
                ...
                <li>You may terminate your account at any time by canceling your subscription</li>
