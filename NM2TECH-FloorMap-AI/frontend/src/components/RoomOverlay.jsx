...
export function RoomOverlay({
  ...
  const offsetX = containerRect ? (containerRect.width - imgRect?.width ?? 0) / 2 + transform.x : 0;
  const offsetY = containerRect ? (containerRect.height - (imgRect?.height ?? 0)) / 2 + transform.y : 0;
